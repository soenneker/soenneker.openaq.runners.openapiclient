...
using Soenneker.OpenAq.Runners.OpenApiClient.Utils.Abstract;
...
namespace Soenneker.OpenAq.Runners.OpenApiClient.Utils;
...
public sealed class FileOperationsUtil : IFileOperationsUtil
{
    ...
    public async ValueTask Process(CancellationToken cancellationToken = default)
    {
        ...
        string openApiDocumentUrl = _configuration["OpenAq:ClientGenerationUrl"] ?? "https://api.openaq.org/openapi.json";
        ...
        await _processUtil.Start("kiota", gitDirectory, $"kiota generate -l CSharp -d \"{filePath}\" -o src/{Constants.Library} -c OpenAqOpenApiClient -n {Constants.Library}",
